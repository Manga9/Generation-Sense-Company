...
<html>
    ...
    <body>
                ...
                <!-- Start Navbar -->
                <nav class="navbar navbar-default navbar-fixed-top contact-nav">
                        ...
                        <?php
                                if (isset($_GET['lang']) && $_GET['lang'] == 'en') { 
                                    ...
                                    echo "<a href='#' class='dropdown-toggle element' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'>" . lang('SERVICES') . "<span class='caret'></span></a>";
                                        ...
                                        echo "</ul>";
                                    echo "</li>";                                            echo "<li><a class='cur' href='../?lang=en#about'>" . lang('ABOUT') . "</a></li>";
                                    echo "<li><a class='cur' href='../?lang=en#work'>" . lang('WORK') . "</a></li>";
                                                                echo "<li><a class='cur' href='blog.php'>" . lang('BLOG') . "</a></li>";

                                    echo "<li class='active'><a class='cur' href='contact.php?lang=en'>" . lang('CONTACT') . "</a></li>";
                                    echo "<li><a class='arab' href='?lang=ar'>عربى</a></li>";

                            } else {
                                    echo "<li class='active'><a class='cur' href='contact.php?lang=ar'>" . lang('CONTACT') . "</a></li>";
                                                                echo "<li><a class='cur' href='blog.php'>" . lang('BLOG') . "</a></li>";
                                    ...
                                    echo "<a href='#' class='dropdown-toggle element' data-toggle='dropdown' role='button' aria-haspopup='true' aria-expanded='false'>" . lang('SERVICES') . "<span class='caret'></span></a>";
                                        ...
                                        echo "</ul>";
                                    echo "</li>";                                            echo "<li><a class='cur' href='../?lang=ar#home'>" . lang('HOME') . "</a></li>";
